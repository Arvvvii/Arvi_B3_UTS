...
4. **Data Retrieval**: Flutter mengambil daftar tiket via HTTP GET ke Golang API, melakukan *parsing* dari JSON ke objek `TicketModel` di dalam layer Repositori, dan diserahkan ke *State Management* (Riverpod) untuk di-*render* ke UI.
